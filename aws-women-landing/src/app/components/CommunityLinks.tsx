...
export default function CommunityLinks() {
  return (
    <section id="comunidade" className="relative py-24 px-4 section-alt">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-md mx-auto mb-4">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {links.map((link, index) => (
            <a
              ...
              className="card-aws rounded-2xl p-5 flex items-center gap-5 group"
            >
              {/* Ícone */}
              <div
                className="shrink-0 w-14 h-14 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300"
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-[family-name:var(--font-orbitron)] text-base font-semibold text-white mb-0.5 group-hover:text-[#ff9900] transition-colors">
                  {link.name}
                </h3>
        ...
        <div className="mt-14 text-center">
          <div className="inline-block card-aws rounded-2xl p-8 max-w-lg w-full">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-aws inline-flex items-center gap-2 py-3 px-7 text-sm"
            >
